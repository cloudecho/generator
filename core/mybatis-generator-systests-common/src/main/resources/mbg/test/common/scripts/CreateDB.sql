...
COMMENT ON TABLE PKFields is '关于此表的描述'
COMMENT ON COLUMN PKFields.firstName is '名';
COMMENT ON COLUMN PKFields.lastName is '姓';
COMMENT ON COLUMN PKFields."birth date" is '出生日期';
