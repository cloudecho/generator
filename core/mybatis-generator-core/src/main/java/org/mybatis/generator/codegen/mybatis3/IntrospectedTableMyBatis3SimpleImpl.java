...
public class IntrospectedTableMyBatis3SimpleImpl extends IntrospectedTableMyBatis3Impl {
    ...
    public String getMyBatis3SqlMapNamespace() {
        if (javaModelGenerators == null || javaModelGenerators.isEmpty()) {
            return super.getMyBatis3SqlMapNamespace();
        }
        return javaModelGenerators.get(0).getCompilationUnits().get(0).getType().toString();
    }
